...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { items_id: @favorite.items_id, user_id: @favorite.user_id } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { items_id: @favorite.items_id, user_id: @favorite.user_id } }
